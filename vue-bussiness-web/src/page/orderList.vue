...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      //
      // })
      this.tableData = DB_OBJ.getOrderList
    },
    changeOrderType (headItem) {
      ...
      var newTableData = _.orderBy(this.$store.getters.getOrderList, headItem.key, this.currentOrder)
      this.$store.commit('updateOrderList', newTableData)
    }
  },
  mounted () {
    // this.getList()
